	...
	<div class="inside">
		...
		<table class="form-table">
			...
			<tr>
				...
				<br />
				<span class="description">
				<?php _e( 'Email address that will be notified in case a question or answer is reported. Leaving empty will disable notification. Note: If a question or answer is reported more than once, only to first report will be emailed, but number of reports and latest reporter will be saved.', QA_TEXTDOMAIN ) ?>
				</span>
				</td>
			</tr>
